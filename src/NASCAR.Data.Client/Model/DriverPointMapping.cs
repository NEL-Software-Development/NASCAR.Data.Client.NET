...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DriverPointMapping :  IEquatable<DriverPointMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverPointMapping" /> class.
        /// </summary>
        ...
        /// <param name="pointsPenalizedThisRace">pointsPenalizedThisRace.</param>
        /// <param name="playoffPointsPenalizedThisRace">playoffPointsPenalizedThisRace.</param>
        /// <param name="top5">top5.</param>
        /// <param name="top10">top10.</param>
        /// <param name="lapsLed">lapsLed.</param>
        /// <param name="dNFs">dNFs.</param>
        ...
        public DriverPointMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? nascarOneRaceId = default(int?), int? historyRaceId = default(int?), int? historyDriverId = default(int?), int? driverMemberId = default(int?), int? position = default(int?), string driver = default(string), int? points = default(int?), int? playoffPoints = default(int?), int? playoffRank = default(int?), int? deltaLeader = default(int?), int? deltaNext = default(int?), int? deltaPlayoff = default(int?), int? projectedPlayoffPoints = default(int?), int? starts = default(int?), int? poles = default(int?), int? wins = default(int?), int? stage1Wins = default(int?), int? stage2Wins = default(int?), int? stage3Wins = default(int?), int? stagePoints = default(int?), int? playoffRaceWins = default(int?), int? playoffStageWins = default(int?), int? pointsEarnedThisRace = default(int?), int? stagePointsEarnedThisRace = default(int?), int? playoffPointsEarnedThisRace = default(int?), int? pointsPenalizedThisRace = default(int?), int? playoffPointsPenalizedThisRace = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? lapsLed = default(int?), int? dNFs = default(int?), bool? isClinch = default(bool?), bool? inPlayoffs = default(bool?), bool? madePlayoffs = default(bool?), int? highestRound = default(int?))
        {
            ...
            this.PointsPenalizedThisRace = pointsPenalizedThisRace;
            this.PlayoffPointsPenalizedThisRace = playoffPointsPenalizedThisRace;
            this.Top5 = top5;
            this.Top10 = top10;
        ...
        /// </summary>
        [DataMember(Name="PlayoffPoints", EmitDefaultValue=false)]
        public int? PlayoffPoints { get; set; }

        /// <summary>
        /// Gets or Sets PlayoffRank
        /// </summary>
        [DataMember(Name="PlayoffRank", EmitDefaultValue=false)]
        public int? PlayoffRank { get; set; }

        /// <summary>
        /// Gets or Sets DeltaLeader
        /// </summary>
        [DataMember(Name="DeltaLeader", EmitDefaultValue=false)]
        public int? DeltaLeader { get; set; }

        /// <summary>
        /// Gets or Sets DeltaNext
        /// </summary>
        [DataMember(Name="DeltaNext", EmitDefaultValue=false)]
        public int? DeltaNext { get; set; }

        /// <summary>
        /// Gets or Sets DeltaPlayoff
        /// </summary>
        [DataMember(Name="DeltaPlayoff", EmitDefaultValue=false)]
        public int? DeltaPlayoff { get; set; }

        /// <summary>
        /// Gets or Sets ProjectedPlayoffPoints
        /// </summary>
        [DataMember(Name="ProjectedPlayoffPoints", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="Stage1Wins", EmitDefaultValue=false)]
        public int? Stage1Wins { get; set; }

        /// <summary>
        /// Gets or Sets Stage2Wins
        /// </summary>
        [DataMember(Name="Stage2Wins", EmitDefaultValue=false)]
        public int? Stage2Wins { get; set; }

        /// <summary>
        /// Gets or Sets Stage3Wins
        /// </summary>
        [DataMember(Name="Stage3Wins", EmitDefaultValue=false)]
        public int? Stage3Wins { get; set; }

        /// <summary>
        /// Gets or Sets StagePoints
        /// </summary>
        [DataMember(Name="StagePoints", EmitDefaultValue=false)]
        public int? StagePoints { get; set; }

        /// <summary>
        /// Gets or Sets PlayoffRaceWins
        /// </summary>
        [DataMember(Name="PlayoffRaceWins", EmitDefaultValue=false)]
        public int? PlayoffRaceWins { get; set; }

        /// <summary>
        /// Gets or Sets PlayoffStageWins
        /// </summary>
        [DataMember(Name="PlayoffStageWins", EmitDefaultValue=false)]
        public int? PlayoffStageWins { get; set; }

        /// <summary>
        /// Gets or Sets PointsEarnedThisRace
        /// </summary>
        [DataMember(Name="PointsEarnedThisRace", EmitDefaultValue=false)]
        public int? PointsEarnedThisRace { get; set; }

        /// <summary>
        /// Gets or Sets StagePointsEarnedThisRace
        /// </summary>
        [DataMember(Name="StagePointsEarnedThisRace", EmitDefaultValue=false)]
        public int? StagePointsEarnedThisRace { get; set; }

        /// <summary>
        /// Gets or Sets PlayoffPointsEarnedThisRace
        /// </summary>
        [DataMember(Name="PlayoffPointsEarnedThisRace", EmitDefaultValue=false)]
        public int? PlayoffPointsEarnedThisRace { get; set; }

        /// <summary>
        /// Gets or Sets PointsPenalizedThisRace
        /// </summary>
        [DataMember(Name="PointsPenalizedThisRace", EmitDefaultValue=false)]
        public int? PointsPenalizedThisRace { get; set; }

        /// <summary>
        /// Gets or Sets PlayoffPointsPenalizedThisRace
        /// </summary>
        [DataMember(Name="PlayoffPointsPenalizedThisRace", EmitDefaultValue=false)]
        public int? PlayoffPointsPenalizedThisRace { get; set; }
        ...
        /// Gets or Sets DNFs
        /// </summary>
        [DataMember(Name="DNFs", EmitDefaultValue=false)]
        public int? DNFs { get; set; }

        /// <summary>
        /// Gets or Sets IsClinch
        /// </summary>
        [DataMember(Name="IsClinch", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="MadePlayoffs", EmitDefaultValue=false)]
        public bool? MadePlayoffs { get; set; }

        /// <summary>
        /// Gets or Sets HighestRound
        /// </summary>
        [DataMember(Name="HighestRound", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverPointMapping {\n");
            ...
            sb.Append("  PointsPenalizedThisRace: ").Append(PointsPenalizedThisRace).Append("\n");
            sb.Append("  PlayoffPointsPenalizedThisRace: ").Append(PlayoffPointsPenalizedThisRace).Append("\n");
            sb.Append("  Top5: ").Append(Top5).Append("\n");
            sb.Append("  Top10: ").Append(Top10).Append("\n");
            sb.Append("  LapsLed: ").Append(LapsLed).Append("\n");
            sb.Append("  DNFs: ").Append(DNFs).Append("\n");
        ...
        {
            return this.Equals(input as DriverPointMapping);
        }

        /// <summary>
        /// Returns true if DriverPointMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverPointMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverPointMapping input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PointsPenalizedThisRace == input.PointsPenalizedThisRace ||
                    (this.PointsPenalizedThisRace != null &&
                    this.PointsPenalizedThisRace.Equals(input.PointsPenalizedThisRace))
                ) && 
                (
                    this.PlayoffPointsPenalizedThisRace == input.PlayoffPointsPenalizedThisRace ||
                    (this.PlayoffPointsPenalizedThisRace != null &&
                    this.PlayoffPointsPenalizedThisRace.Equals(input.PlayoffPointsPenalizedThisRace))
                ) && 
                (
                ...
                (
                    this.DNFs == input.DNFs ||
                    (this.DNFs != null &&
                    this.DNFs.Equals(input.DNFs))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PointsPenalizedThisRace != null)
                    hashCode = hashCode * 59 + this.PointsPenalizedThisRace.GetHashCode();
                if (this.PlayoffPointsPenalizedThisRace != null)
                    hashCode = hashCode * 59 + this.PlayoffPointsPenalizedThisRace.GetHashCode();
                if (this.Top5 != null)
                ...
                if (this.DNFs != null)
                    hashCode = hashCode * 59 + this.DNFs.GetHashCode();
