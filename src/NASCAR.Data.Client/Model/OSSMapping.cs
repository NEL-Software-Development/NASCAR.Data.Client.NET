...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OSSMapping :  IEquatable<OSSMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OSSMapping" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OSSMapping);
        }

        /// <summary>
        /// Returns true if OSSMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of OSSMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OSSMapping input)
        {
            if (input == null)
                return false;
