...
{
    /// <summary>
    /// Represents a NASCAR driver and their associated biographical and career information
    /// </summary>
    [DataContract]
        public partial class Driver :  IEquatable<Driver>, IValidatableObject
    {
        ...
        /// <param name="historyDriverId">Historical identifier for the driver.</param>
        /// <param name="hometownCity">The driver&#x27;s hometown city.</param>
        ...
        public Driver(int? id = default(int?), string name = default(string), DateTimeOffset? dateOfBirth = default(DateTimeOffset?), DateTimeOffset? dateOfDeath = default(DateTimeOffset?), int? historyDriverId = default(int?), string hometownCity = default(string), string hometownState = default(string), string hometownCountry = default(string), string residesCity = default(string), string residesState = default(string), string residesCountry = default(string), int? series1RookieYear = default(int?), int? series2RookieYear = default(int?), int? series3RookieYear = default(int?), string hobbies = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        /// <summary>
        /// Historical identifier for the driver
        /// </summary>
        /// <value>Historical identifier for the driver</value>
        [DataMember(Name="history_driver_id", EmitDefaultValue=false)]
        public int? HistoryDriverId { get; set; }

        /// <summary>
        /// The driver&#x27;s hometown city
        /// </summary>
        /// <value>The driver&#x27;s hometown city</value>
