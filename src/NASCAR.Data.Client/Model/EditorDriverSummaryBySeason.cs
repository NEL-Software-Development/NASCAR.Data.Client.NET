...
{
    /// <summary>
    /// EditorDriverSummaryBySeason
    /// </summary>
    [DataContract]
        public partial class EditorDriverSummaryBySeason :  IEquatable<EditorDriverSummaryBySeason>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditorDriverSummaryBySeason" /> class.
        /// </summary>
        ...
        /// <param name="finishRank">finishRank.</param>
        public EditorDriverSummaryBySeason(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? summaryID = default(int?), int? seriesID = default(int?), int? historyDriverID = default(int?), int? totalRaces = default(int?), int? wins = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? poles = default(int?), int? dNF = default(int?), int? runningAtFinish = default(int?), int? leadLapFinish = default(int?), int? lapsCompleted = default(int?), int? lapsLed = default(int?), double? averageStart = default(double?), double? averageFinish = default(double?), double? milesCompleted = default(double?), string eTLDriverName = default(string), int? eTLDriverID = default(int?), int? season = default(int?), int? finishRank = default(int?))
        {
        ...
        /// <summary>
        /// Gets or Sets FinishRank
        /// </summary>
        [DataMember(Name="FinishRank", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EditorDriverSummaryBySeason {\n");
        ...
        {
            return this.Equals(input as EditorDriverSummaryBySeason);
        }

        /// <summary>
        /// Returns true if EditorDriverSummaryBySeason instances are equal
        /// </summary>
        /// <param name="input">Instance of EditorDriverSummaryBySeason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditorDriverSummaryBySeason input)
        {
            if (input == null)
                return false;
