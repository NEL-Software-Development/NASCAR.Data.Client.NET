...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VehicleMapping :  IEquatable<VehicleMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleMapping" /> class.
        /// </summary>
        ...
        public VehicleMapping(int? season = default(int?), int? seriesId = default(int?), string number = default(string), string badge = default(string), PublishState? publishState = default(PublishState?), int? id = default(int?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), Guid? trackingId = default(Guid?))
        {
            this.Season = season;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleMapping {\n");
        ...
        {
            return this.Equals(input as VehicleMapping);
        }

        /// <summary>
        /// Returns true if VehicleMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleMapping input)
        {
            if (input == null)
                return false;
