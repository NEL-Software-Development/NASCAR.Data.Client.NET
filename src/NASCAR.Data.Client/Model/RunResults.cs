...
namespace NASCAR.Data.Client.Model
{
        ...
        public partial class RunResults :  IEquatable<RunResults>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RunResults);
        }

        /// <summary>
        /// Returns true if RunResults instances are equal
        /// </summary>
        /// <param name="input">Instance of RunResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunResults input)
        {
            if (input == null)
                return false;
