...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DriverMapping :  IEquatable<DriverMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverMapping" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DriverMapping);
        }

        /// <summary>
        /// Returns true if DriverMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverMapping input)
        {
            if (input == null)
                return false;
