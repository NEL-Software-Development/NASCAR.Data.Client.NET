...
{
    /// <summary>
    /// Represents a driver&#x27;s career summary statistics for a specific track type
    /// </summary>
    [DataContract]
        public partial class DriverSummaryByTrackType :  IEquatable<DriverSummaryByTrackType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverSummaryByTrackType" /> class.
        /// </summary>
        ...
        /// <param name="trackType">Track type: (Intermediate, Other, Road Course, Short Track, Super Speedway).</param>
        public DriverSummaryByTrackType(double? averageStart = default(double?), double? averageFinish = default(double?), int? dnf = default(int?), int? driverId = default(int?), int? lapsCompleted = default(int?), int? lapsLed = default(int?), int? leadLapFinish = default(int?), double? milesCompleted = default(double?), int? poles = default(int?), int? runningAtFinish = default(int?), int? seriesId = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? totalRaces = default(int?), int? wins = default(int?), string trackType = default(string))
        {
        ...
        /// <summary>
        /// Track type: (Intermediate, Other, Road Course, Short Track, Super Speedway)
        /// </summary>
        /// <value>Track type: (Intermediate, Other, Road Course, Short Track, Super Speedway)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverSummaryByTrackType {\n");
        ...
        {
            return this.Equals(input as DriverSummaryByTrackType);
        }

        /// <summary>
        /// Returns true if DriverSummaryByTrackType instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverSummaryByTrackType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverSummaryByTrackType input)
        {
            if (input == null)
                return false;
