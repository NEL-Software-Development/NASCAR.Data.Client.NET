...
namespace NASCAR.Data.Client.Model
{
        ...
        public partial class DriverSummaryByTrackType :  IEquatable<DriverSummaryByTrackType>, IValidatableObject
    {
        ...
        public DriverSummaryByTrackType(int? id = default(int?), double? averageStart = default(double?), double? averageFinish = default(double?), int? dnf = default(int?), int? driverId = default(int?), int? lapsCompleted = default(int?), int? lapsLed = default(int?), int? leadLapFinish = default(int?), double? milesCompleted = default(double?), int? poles = default(int?), int? runningAtFinish = default(int?), int? seriesId = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? totalRaces = default(int?), int? wins = default(int?), string trackType = default(string))
        {
            this.Id = id;
