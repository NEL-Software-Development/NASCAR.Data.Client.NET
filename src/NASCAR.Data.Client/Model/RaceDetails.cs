...
{
    /// <summary>
    /// Represents detailed information for a race event including entries, runs, and schedule
    /// </summary>
    [DataContract]
        public partial class RaceDetails :  IEquatable<RaceDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="tuneinDate">Next scheduled start for a race, updated if race is delayed or rescheduled.</param>
        /// <param name="qualifyingDate">Date qualifying was held for this race.</param>
        /// <param name="comments">Race Comments.</param>
        /// <param name="trackName">Track Name.</param>
        /// <param name="trackSponsor">Track sponsor name.</param>
        ...
        /// <param name="stages">Stages associated with the race.</param>
        /// <param name="schedule">Weekend schedule entries for the race.</param>
        /// <param name="fastestLapAward">fastestLapAward.</param>
        public RaceDetails(int? id = default(int?), int? historyRaceId = -1, int? seriesId = default(int?), string name = default(string), int? raceNumber = default(int?), string promoter = default(string), bool? restrictorPlate = default(bool?), int? laps = default(int?), int? actualLaps = default(int?), double? distance = default(double?), double? actualDistance = default(double?), int? raceTypeId = default(int?), string totalRaceTime = default(string), int? numberOfCarsInField = default(int?), int? poleWinnerDriverId = default(int?), double? poleWinnerSpeed = default(double?), int? numberOfLeadChanges = default(int?), int? numberOfLeaders = default(int?), double? averageSpeed = default(double?), string marginOfVictory = default(string), string radioBroadcaster = default(string), string televisionBroadcaster = default(string), string satelliteRadioBroadcaster = default(string), int? playoffRound = default(int?), bool? isQualifyingRace = default(bool?), int? qualifyingRaceNo = default(int?), int? qualifyingRaceId = default(int?), bool? hasQualifying = default(bool?), DateTimeOffset? date = default(DateTimeOffset?), DateTimeOffset? tuneinDate = default(DateTimeOffset?), DateTimeOffset? qualifyingDate = default(DateTimeOffset?), string comments = default(string), string trackName = default(string), string trackSponsor = default(string), int? trackId = default(int?), int? historyTrackId = default(int?), bool? inspectionComplete = default(bool?), Collection<RunEntry> entries = default(Collection<RunEntry>), Collection<RunDetails> runs = default(Collection<RunDetails>), Collection<Stage> stages = default(Collection<Stage>), Collection<WeekendSchedule> schedule = default(Collection<WeekendSchedule>), FastestLapAwards fastestLapAward = default(FastestLapAwards))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Next scheduled start for a race, updated if race is delayed or rescheduled
        /// </summary>
        /// <value>Next scheduled start for a race, updated if race is delayed or rescheduled</value>
        [DataMember(Name="tunein_date", EmitDefaultValue=false)]
        public DateTimeOffset? TuneinDate { get; set; }
        ...
        [DataMember(Name="track_sponsor", EmitDefaultValue=false)]
        public string TrackSponsor { get; set; }
        ...
        /// <summary>
        /// Stages associated with the race
        /// </summary>
        /// <value>Stages associated with the race</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TuneinDate: ").Append(TuneinDate).Append("\n");
        ...
        {
            return this.Equals(input as RaceDetails);
        }

        /// <summary>
        /// Returns true if RaceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of RaceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceDetails input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TuneinDate == input.TuneinDate ||
                    (this.TuneinDate != null &&
                    this.TuneinDate.Equals(input.TuneinDate))
                ) && 
                (
                ...
                (
                    this.TrackSponsor == input.TrackSponsor ||
                    (this.TrackSponsor != null &&
                    this.TrackSponsor.Equals(input.TrackSponsor))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TuneinDate != null)
                    hashCode = hashCode * 59 + this.TuneinDate.GetHashCode();
                ...
                if (this.TrackSponsor != null)
                    hashCode = hashCode * 59 + this.TrackSponsor.GetHashCode();
