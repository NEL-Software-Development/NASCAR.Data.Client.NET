...
namespace NASCAR.Data.Client.Model
{
        ...
        public partial class ConeCoordinates :  IEquatable<ConeCoordinates>, IValidatableObject
    {
        ...
        public ConeCoordinates(int? id = default(int?), int? raceId = default(int?), double? latitude = default(double?), double? longitude = default(double?), double? altitude = default(double?), string loc = default(string), DateTimeOffset? lastUpdate = default(DateTimeOffset?))
        {
            this.Id = id;
            this.RaceId = raceId;
