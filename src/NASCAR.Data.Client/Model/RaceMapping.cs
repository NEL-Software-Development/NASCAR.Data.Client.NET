...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RaceMapping :  IEquatable<RaceMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RaceMapping" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RaceMapping);
        }

        /// <summary>
        /// Returns true if RaceMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of RaceMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceMapping input)
        {
            if (input == null)
                return false;
