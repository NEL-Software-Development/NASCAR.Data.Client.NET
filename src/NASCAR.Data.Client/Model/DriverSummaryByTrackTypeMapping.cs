...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DriverSummaryByTrackTypeMapping :  IEquatable<DriverSummaryByTrackTypeMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverSummaryByTrackTypeMapping" /> class.
        /// </summary>
        ...
        /// <param name="historyTrackType">historyTrackType.</param>
        /// <param name="historyTrackTypeID">historyTrackTypeID.</param>
        public DriverSummaryByTrackTypeMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? summaryID = default(int?), int? seriesID = default(int?), int? historyDriverID = default(int?), int? totalRaces = default(int?), int? wins = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? poles = default(int?), int? dNF = default(int?), int? runningAtFinish = default(int?), int? leadLapFinish = default(int?), int? lapsCompleted = default(int?), int? lapsLed = default(int?), double? averageStart = default(double?), double? averageFinish = default(double?), double? milesCompleted = default(double?), string eTLDriverName = default(string), int? eTLDriverID = default(int?), string historyTrackType = default(string), int? historyTrackTypeID = default(int?))
        {
            ...
            this.HistoryTrackType = historyTrackType;
            this.HistoryTrackTypeID = historyTrackTypeID;
        }
        ...
        /// <summary>
        /// Gets or Sets HistoryTrackType
        /// </summary>
        [DataMember(Name="History_TrackType", EmitDefaultValue=false)]
        public string HistoryTrackType { get; set; }

        /// <summary>
        /// Gets or Sets HistoryTrackTypeID
        /// </summary>
        [DataMember(Name="History_TrackTypeID", EmitDefaultValue=false)]
        public int? HistoryTrackTypeID { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverSummaryByTrackTypeMapping {\n");
            ...
            sb.Append("  HistoryTrackType: ").Append(HistoryTrackType).Append("\n");
            sb.Append("  HistoryTrackTypeID: ").Append(HistoryTrackTypeID).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DriverSummaryByTrackTypeMapping);
        }

        /// <summary>
        /// Returns true if DriverSummaryByTrackTypeMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverSummaryByTrackTypeMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverSummaryByTrackTypeMapping input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HistoryTrackType == input.HistoryTrackType ||
                    (this.HistoryTrackType != null &&
                    this.HistoryTrackType.Equals(input.HistoryTrackType))
                ) && 
                (
                    this.HistoryTrackTypeID == input.HistoryTrackTypeID ||
                    (this.HistoryTrackTypeID != null &&
                    this.HistoryTrackTypeID.Equals(input.HistoryTrackTypeID))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HistoryTrackType != null)
                    hashCode = hashCode * 59 + this.HistoryTrackType.GetHashCode();
                if (this.HistoryTrackTypeID != null)
                    hashCode = hashCode * 59 + this.HistoryTrackTypeID.GetHashCode();
                return hashCode;
            }
        }
