...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DriverSummaryByTrackMapping :  IEquatable<DriverSummaryByTrackMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverSummaryByTrackMapping" /> class.
        /// </summary>
        ...
        /// <param name="eTLTrackName">eTLTrackName.</param>
        /// <param name="season">season.</param>
        public DriverSummaryByTrackMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? summaryID = default(int?), int? seriesID = default(int?), int? historyDriverID = default(int?), int? totalRaces = default(int?), int? wins = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? poles = default(int?), int? dNF = default(int?), int? runningAtFinish = default(int?), int? leadLapFinish = default(int?), int? lapsCompleted = default(int?), int? lapsLed = default(int?), double? averageStart = default(double?), double? averageFinish = default(double?), double? milesCompleted = default(double?), string eTLDriverName = default(string), int? eTLDriverID = default(int?), int? historyTrackID = default(int?), int? eTLTrackID = default(int?), string eTLTrackName = default(string), int? season = default(int?))
        {
            ...
            this.ETLTrackName = eTLTrackName;
            this.Season = season;
        }
        ...
        /// <summary>
        /// Gets or Sets ETLTrackName
        /// </summary>
        [DataMember(Name="ETL_TrackName", EmitDefaultValue=false)]
        public string ETLTrackName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverSummaryByTrackMapping {\n");
            ...
            sb.Append("  ETLTrackName: ").Append(ETLTrackName).Append("\n");
        ...
        {
            return this.Equals(input as DriverSummaryByTrackMapping);
        }

        /// <summary>
        /// Returns true if DriverSummaryByTrackMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverSummaryByTrackMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverSummaryByTrackMapping input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ETLTrackName == input.ETLTrackName ||
                    (this.ETLTrackName != null &&
                    this.ETLTrackName.Equals(input.ETLTrackName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ETLTrackName != null)
                    hashCode = hashCode * 59 + this.ETLTrackName.GetHashCode();
                if (this.Season != null)
