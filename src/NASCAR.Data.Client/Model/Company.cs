...
namespace NASCAR.Data.Client.Model
{
        ...
        public partial class Company :  IEquatable<Company>, IValidatableObject
    {
        ...
        public Company(string name = default(string), string abbreviation = default(string), string alias = default(string), int? categoryId = default(int?), string categoryName = default(string))
        {
            this.Name = name;
