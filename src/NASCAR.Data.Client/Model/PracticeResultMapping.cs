...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PracticeResultMapping :  IEquatable<PracticeResultMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PracticeResultMapping" /> class.
        /// </summary>
        ...
        public PracticeResultMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? finishPosition = default(int?), int? bestTime = default(int?), double? bestSpeed = default(double?), int? deltaNextTime = default(int?), int? deltaNextLaps = default(int?), int? deltaLeaderTime = default(int?), int? deltaLeaderLaps = default(int?), int? bestLap = default(int?), int? lastLapTime = default(int?), int? laps = default(int?), string vehicleNumber = default(string), string driverName = default(string), bool? onTrack = default(bool?), string runName = default(string), string runState = default(string), string status = default(string), string comment = default(string), int? nascarOneRaceId = default(int?), int? timingRunId = default(int?), int? eTLRunId = default(int?), int? entryId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PracticeResultMapping {\n");
        ...
        {
            return this.Equals(input as PracticeResultMapping);
        }

        /// <summary>
        /// Returns true if PracticeResultMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of PracticeResultMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PracticeResultMapping input)
        {
            if (input == null)
                return false;
