...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EditorLoopStat :  IEquatable<EditorLoopStat>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditorLoopStat" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EditorLoopStat {\n");
        ...
        {
            return this.Equals(input as EditorLoopStat);
        }

        /// <summary>
        /// Returns true if EditorLoopStat instances are equal
        /// </summary>
        /// <param name="input">Instance of EditorLoopStat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditorLoopStat input)
        {
            if (input == null)
                return false;
