...
{
    /// <summary>
    /// Represents the fastest lap results for each lap in a run
    /// </summary>
    [DataContract]
        public partial class FastestLapResult :  IEquatable<FastestLapResult>, IValidatableObject
    {
        ...
        public FastestLapResult(int? raceId = default(int?), int? runId = default(int?), int? timingRunId = default(int?), int? laps = default(int?), Collection<LapChart> items = default(Collection<LapChart>))
        {
            this.RaceId = raceId;
            this.RunId = runId;
