...
namespace NASCAR.Data.Client.Model
{
        ...
        public partial class DriverPointsView :  IEquatable<DriverPointsView>, IValidatableObject
    {
        ...
        public DriverPointsView(int? seriesId = default(int?), int? historyRaceId = default(int?), int? timingRunId = default(int?), int? playoffRoundNumber = default(int?), Collection<DriverPointsSlim> driverPoints = default(Collection<DriverPointsSlim>))
        {
