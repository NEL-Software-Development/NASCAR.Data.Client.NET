...
{
    /// <summary>
    /// Represents the results of a race run including current run state and flag state
    /// </summary>
    [DataContract]
        public partial class RaceRunResults :  IEquatable<RaceRunResults>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RaceRunResults);
        }

        /// <summary>
        /// Returns true if RaceRunResults instances are equal
        /// </summary>
        /// <param name="input">Instance of RaceRunResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceRunResults input)
        {
            if (input == null)
                return false;
