...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OwnerPointMapping :  IEquatable<OwnerPointMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerPointMapping" /> class.
        /// </summary>
        ...
        /// <param name="ownerMemberId">ownerMemberId.</param>
        ...
        public OwnerPointMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? nascarOneRaceId = default(int?), int? historyRaceId = default(int?), int? ownerMemberId = default(int?), int? position = default(int?), string vehicleNumber = default(string), string owner = default(string), int? points = default(int?), int? playoffPoints = default(int?), int? playoffRank = default(int?), int? deltaLeader = default(int?), int? deltaNext = default(int?), int? starts = default(int?), int? poles = default(int?), int? wins = default(int?), int? stage1Wins = default(int?), int? stage2Wins = default(int?), int? stage3Wins = default(int?), int? stagePoints = default(int?), int? playoffRaceWins = default(int?), int? playoffStageWins = default(int?), int? pointsEarnedThisRace = default(int?), int? stagePointsEarnedThisRace = default(int?), int? playoffPointsEarnedThisRace = default(int?), int? pointsPenalizedThisRace = default(int?), int? playoffPointsPenalizedThisRace = default(int?), int? top5 = default(int?), int? top10 = default(int?), int? lapsLed = default(int?), int? dNFs = default(int?), bool? inPlayoffs = default(bool?), bool? madePlayoffs = default(bool?), int? highestRound = default(int?))
        {
        ...
        /// <summary>
        /// Gets or Sets OwnerMemberId
        /// </summary>
        [DataMember(Name="OwnerMemberId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OwnerPointMapping {\n");
            ...
            sb.Append("  OwnerMemberId: ").Append(OwnerMemberId).Append("\n");
        ...
        {
            return this.Equals(input as OwnerPointMapping);
        }

        /// <summary>
        /// Returns true if OwnerPointMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerPointMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerPointMapping input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OwnerMemberId == input.OwnerMemberId ||
                    (this.OwnerMemberId != null &&
                    this.OwnerMemberId.Equals(input.OwnerMemberId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OwnerMemberId != null)
                    hashCode = hashCode * 59 + this.OwnerMemberId.GetHashCode();
