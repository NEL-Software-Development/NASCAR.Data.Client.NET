...
namespace NASCAR.Data.Client.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActiveRun" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Current flag state (Green, Yellow, Red, Checkered, White, Stop, NoActiveFlag, Warm, Invalid)
        /// </summary>
        /// <value>Current flag state (Green, Yellow, Red, Checkered, White, Stop, NoActiveFlag, Warm, Invalid)</value>
        ...
        {
            return this.Equals(input as ActiveRun);
        }

        /// <summary>
        /// Returns true if ActiveRun instances are equal
        /// </summary>
        /// <param name="input">Instance of ActiveRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiveRun input)
        {
            if (input == null)
                return false;
