...
{
    /// <summary>
    /// Represents a run with its associated flag history
    /// </summary>
    [DataContract]
        public partial class RunDetails :  IEquatable<RunDetails>, IValidatableObject
    {
        ...
        /// <param name="timingRunId">Timing system run identifier.</param>
        ...
        /// <summary>
        /// Timing system run identifier
        /// </summary>
        /// <value>Timing system run identifier</value>
        [DataMember(Name="timing_run_id", EmitDefaultValue=false)]
        public int? TimingRunId { get; set; }

        /// <summary>
        /// Current flag state derived from the last flag in the run:  (NONE, WARMUP, GREEN, YELLOW, RED, WHITE, FINISH, EXTRA)
        /// </summary>
        /// <value>Current flag state derived from the last flag in the run:  (NONE, WARMUP, GREEN, YELLOW, RED, WHITE, FINISH, EXTRA)</value>
