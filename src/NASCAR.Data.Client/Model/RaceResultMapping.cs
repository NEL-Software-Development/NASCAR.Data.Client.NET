...
namespace NASCAR.Data.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RaceResultMapping :  IEquatable<RaceResultMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RaceResultMapping" /> class.
        /// </summary>
        ...
        public RaceResultMapping(PublishState? publishState = default(PublishState?), int? id = default(int?), Guid? trackingId = default(Guid?), bool? inDataWarehouse = default(bool?), bool? manuallySet = default(bool?), DateTimeOffset? lastUpdate = default(DateTimeOffset?), string lastUpdatedBy = default(string), int? entryId = default(int?), int? finishPosition = default(int?), int? bestTime = default(int?), double? bestSpeed = default(double?), int? lastLapTime = default(int?), int? deltaNextTime = default(int?), int? deltaNextLaps = default(int?), int? deltaLeaderTime = default(int?), int? deltaLeaderLaps = default(int?), int? bestLap = default(int?), int? laps = default(int?), string vehicleNumber = default(string), string driverName = default(string), bool? onTrack = default(bool?), string status = default(string), string comment = default(string), string runName = default(string), string runState = default(string), int? nascarOneRaceId = default(int?), int? timingRunId = default(int?), int? eTLRunId = default(int?), int? startPosition = default(int?), int? pitBox = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RaceResultMapping {\n");
        ...
        {
            return this.Equals(input as RaceResultMapping);
        }

        /// <summary>
        /// Returns true if RaceResultMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of RaceResultMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceResultMapping input)
        {
            if (input == null)
                return false;
