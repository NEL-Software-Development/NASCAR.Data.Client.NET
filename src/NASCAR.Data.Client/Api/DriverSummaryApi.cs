...
namespace NASCAR.Data.Client.Api
{
    ...
    /// </summary>
        public interface IDriverSummaryApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class DriverSummaryApi : IDriverSummaryApi
    {
        private NASCAR.Data.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DriverSummaryApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DriverSummaryApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DriverSummaryApi(NASCAR.Data.Client.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< Collection<DriverSummary> > DriverSummaryGetWithHttpInfo (int? seriesId = null, int? season = null, int? driverId = null)
        {
            ...
            return new ApiResponse<Collection<DriverSummary>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Collection<DriverSummary>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Collection<DriverSummary>)));
        }
