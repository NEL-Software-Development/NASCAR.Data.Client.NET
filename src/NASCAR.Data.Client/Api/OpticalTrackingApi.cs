...
namespace NASCAR.Data.Client.Api
{
    ...
    /// </summary>
        public interface IOpticalTrackingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class OpticalTrackingApi : IOpticalTrackingApi
    {
        private NASCAR.Data.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="OpticalTrackingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public OpticalTrackingApi(String basePath)
        {
        ...
        /// <returns></returns>
        public OpticalTrackingApi(NASCAR.Data.Client.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< Collection<OpticalTrackingUTMOffset> > OpticalTrackingUtmOffsetsGetWithHttpInfo ()
        {
            ...
            return new ApiResponse<Collection<OpticalTrackingUTMOffset>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Collection<OpticalTrackingUTMOffset>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Collection<OpticalTrackingUTMOffset>)));
        }
