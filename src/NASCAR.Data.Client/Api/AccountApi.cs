...
namespace NASCAR.Data.Client.Api
{
        ...
        public interface IAccountApi : IApiAccessor
    {
        ...
        /// <param name="refreshToken">The refresh token obtained from a previous authentication.  Used to obtain a new access token without requiring user credentials. (optional)</param>
        ...
        public partial class AccountApi : IAccountApi
    {
        ...
        /// <returns></returns>
        public AccountApi(NASCAR.Data.Client.Client.Configuration configuration = null)
        {
