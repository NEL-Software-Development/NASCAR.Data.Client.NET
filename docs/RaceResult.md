# NASCAR.Data.Client.Model.RaceResult
## Properties
...
**PitBox** | **int?** | Pit box assigned to the vehicle for the race | [optional] 
**Disqualified** | **bool?** | Indicates whether the vehicle was disqualified | [optional] 
