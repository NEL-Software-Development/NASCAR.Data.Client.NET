...
[**RaceEntryGet**](RaceApi.md#raceentryget) | **GET** /race/entry | Retrieves the details of a race entry.
...
[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)
<a name="raceentryget"></a>
# **RaceEntryGet**
> RunEntry RaceEntryGet (int? entryId = null)

Retrieves the details of a race entry.
...
namespace Example
{
    public class RaceEntryGetExample
    {
        public void main()
        {

            var apiInstance = new RaceApi();
            var entryId = 56;  // int? | The unique identifier of the race entry. (optional) 

            try
            {
                // Retrieves the details of a race entry.
                RunEntry result = apiInstance.RaceEntryGet(entryId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling RaceApi.RaceEntryGet: " + e.Message );
            }
        }
    }
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **entryId** | **int?**| The unique identifier of the race entry. | [optional] 
...
<br/><b>⚠ Deprecated:</b> Removal on 2026-06-30. Use /stats/loop-stats instead.
...
<br/><b>⚠ Deprecated:</b> Removal on 2026-06-30. Use /stats/report instead.
...
<br/><b>⚠ Deprecated:</b> Removal on 2026-06-30. Use /stats/reports instead.
